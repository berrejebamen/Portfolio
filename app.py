...
# Assets for about me
img_utown = Image.open("images/fb_taswira.jpg")
img_lh = Image.open("images/linkedin_taswira.jpg")
# Assets for education
img_nus = Image.open("images/enit.jpg")
img_poc = Image.open("images/ipein.png")
# Assets for experiences
img_saf = Image.open("images/tt.png")
img_groundup = Image.open("images/m&c.png")
# Assets for experiences
img_ieee = Image.open("images/IEEE.png")
img_gdsc = Image.open("images/GDSC.png")
# Assets for projects
img_qt=Image.open("images/qt.png")
img_neural=Image.open("images/neural.jpg")
img_geo=Image.open("images/geospatial.jpg")
img_breast=Image.open("images/breast_cancer.png")
img_racing=Image.open("images/racing.png")
img_jax=Image.open("images/jax.png")
# Assets for contact
    ...
    if selected == "Summary":
        ...
        with st.container():
          ...
          with mid:
            ...
            st.image("images/plan.png", caption="Modules for Final Year")  
